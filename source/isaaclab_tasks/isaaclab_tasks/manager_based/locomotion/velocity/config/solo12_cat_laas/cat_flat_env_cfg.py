...
# Pre-defined configs
##
from isaaclab_tasks.direct.solo12_laas.solo12_laas_env_cfg import SOLO12_LAAS_CFG
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = SOLO12_LAAS_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
